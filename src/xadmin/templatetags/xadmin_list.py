...
def pagination_tag(parser, token):
    return InclusionAdminNode(
        ...
        token,
        func=pagination,
        template_name="xpagination.html",
        takes_context=False,
    )
...
def result_headers(cl):
    ...
    for i, field_name in enumerate(cl.list_display):
        ...
        yield {
            ...
            "class_attrib": (
                format_html(' class="{}"', " ".join(
                    th_classes)) if th_classes else ""
            ),
        }
...
def result_list_tag(parser, token):
    return InclusionAdminNode(
        ...
        token,
        func=result_list,
        template_name="xchange_list_results.html",
        takes_context=False,
    )
...
def date_hierarchy_tag(parser, token):
    return InclusionAdminNode(
        ...
        token,
        func=date_hierarchy,
        template_name="xdate_hierarchy.html",
        takes_context=False,
    )
...
def search_form_tag(parser, token):
    return InclusionAdminNode(
        ...
        token,
        func=search_form,
        template_name="xsearch_form.html",
        takes_context=False,
    )
...
def admin_actions_tag(parser, token):
    return InclusionAdminNode(
        parser, token, func=admin_actions, template_name="xactions.html"
    )
...
def change_list_object_tools_tag(parser, token):
    ...
    return InclusionAdminNode(
        ...
        template_name="xchange_list_object_tools.html",
    )
